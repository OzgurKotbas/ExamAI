...
const translations = {
  tr: {
    ...
    quizStuckPending: 'Sınav uzun süredir bekliyor. Arka plan işleyicisi (worker) çalışmıyor olabilir — yöneticiye bildirin veya daha sonra tekrar deneyin.',
    apiKeyRequired: 'Gemini API key girilmemiş! Profil ayarlarından API anahtarınızı ekleyin.',
    statsUploaded: 'Yüklenen Kaynak',
    statsCreated: 'Oluşturulan Sınav',
    statsCompleted: 'Tamamlanan',

    // Free limit banner
    freeLimitTitle: '🔑 Ücretsiz Kullanım Hakkınız Doldu',
    freeLimitDesc: 'Ücretsiz kullanım hakkınızın tamamı olan 3 sınavı doldurdunuz.',
    freeLimitCta: 'Sınav oluşturmaya devam etmek için',
    freeLimitLink: 'Google AI Studio',
    freeLimitCta2: "üzerinden Gemini API key alarak Hesap Bilgileri kısmından API key'inizi ve modelinizi seçebilirsiniz.",
    freeLimitGoSettings: 'Hesap Bilgilerine Git →',
    freeLimitCreateDisabled: 'Sınav oluşturma hakkınız doldu. Devam etmek için API key ekleyin.',

    // Welcome modal (first login)
    welcomeModalTitle: "ExamAI'e Hoş Geldiniz! 🎉",
    welcomeModalDesc: 'ExamAI, yapay zeka destekli kişiselleştirilmiş sınav oluşturma uygulamasıdır.',
    welcomeModalApiTitle: 'Kişisel API Key ile Sınırsız Kullanım',
    welcomeModalApiDesc1: "API key'inizi Hesap Bilgileri kısmından ekleyerek kişisel sınav oluşturma hizmetinden sınırsız yararlanabilirsiniz.",
    welcomeModalFreeTitle: '🆓 Ücretsiz Deneme Hakkı',
    welcomeModalFreeDesc: 'API key eklemeden önce 3 ücretsiz sınav oluşturarak uygulamayı deneyebilirsiniz.',
    welcomeModalClose: 'Anladım, Başlayalım!',

    // Upload first (improved)
    uploadFirstTitle: 'Önce Ders Notu Yükleyin',
    uploadFirstDesc: 'Sınav oluşturabilmek için yukarıdaki "1. Kaynak Yükle" bölümünden en az bir ders notu, PDF veya belge yüklemeniz gerekmektedir.',
    uploadFirstHint: 'Desteklenen formatlar: PDF, DOCX, TXT, JPG, PNG',
    selectResource: 'Sınav için bir kaynak seçin',
    selectedResource: 'Seçili Kaynak',
    error: 'Bir hata oluştu',
    uploadFirst: 'Sınav oluşturabilmek için önce bir belge yükleyin ↑',
  ...
  en: {
    ...
    quizStuckPending: 'Quiz has been waiting too long. The background worker may be down — contact support or try again later.',
    apiKeyRequired: 'No Gemini API key set! Add your API key in Profile settings.',
    statsUploaded: 'Uploaded Resources',
    statsCreated: 'Created Quizzes',
    statsCompleted: 'Completed',

    // Free limit banner
    freeLimitTitle: '🔑 Free Quiz Limit Reached',
    freeLimitDesc: 'You have used all 3 of your free quiz credits.',
    freeLimitCta: 'To continue creating quizzes, get a Gemini API key from',
    freeLimitLink: 'Google AI Studio',
    freeLimitCta2: 'and add it in your Account Settings along with your preferred model.',
    freeLimitGoSettings: 'Go to Account Settings →',
    freeLimitCreateDisabled: 'Free quiz limit reached. Add an API key to continue.',

    // Welcome modal (first login)
    welcomeModalTitle: 'Welcome to ExamAI! 🎉',
    welcomeModalDesc: 'ExamAI is an AI-powered personalized quiz creation application.',
    welcomeModalApiTitle: 'Unlimited Usage with Your Personal API Key',
    welcomeModalApiDesc1: 'Get an API key from Google AI Studio to use unlimited personalized quiz creation. You can add your API key in Account Settings.',
    welcomeModalFreeTitle: '🆓 Free Trial',
    welcomeModalFreeDesc: 'You can try the app by creating up to 3 free quizzes before adding an API key.',
    welcomeModalClose: 'Got it, Let\'s Start!',

    // Upload first (improved)
    uploadFirstTitle: 'Upload a Study Material First',
    uploadFirstDesc: 'To create a quiz, please upload at least one study note, PDF or document using the "1. Upload Resource" section above.',
    uploadFirstHint: 'Supported formats: PDF, DOCX, TXT, JPG, PNG',
    selectResource: 'Select a resource for the quiz',
    selectedResource: 'Selected Resource',
    error: 'An error occurred',
    uploadFirst: 'Upload a document first to create a quiz ↑',
