...
celery_app.conf.update(
    ...
    result_expires=86400,  # BUG FIX: 1 saat → 24 saat. 1 saatlik TTL her görev
                            # için gereğsiz EXPIRE komutları üretiyordu.
                            # 24 saatlik TTL ile Redis komut yükleme azalır.
    result_compression="zlib",  # Sonuç boyutunu küçült (Redis bellek tasarrufu)
    task_routes={
