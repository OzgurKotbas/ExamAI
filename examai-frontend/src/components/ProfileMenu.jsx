...
export default function ProfileMenu() {
  ...
  // Dashboard'dan gelen 'open-profile-menu' event'ini dinle
  useEffect(() => {
    const handler = () => {
      setShowAccountModal(true);
    };
    window.addEventListener('open-profile-menu', handler);
    return () => window.removeEventListener('open-profile-menu', handler);
  }, []);
